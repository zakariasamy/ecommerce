    ...
    <div class="main-menu-content">
       ...
       <li class="nav-item"><a href=""><i class="la la-group"></i>
        ...
        @can('attributes')
            ...
            <ul class="menu-content">
            <li class="active"><a class="menu-item" href="{{route('admin.products.attributes')}}"
                                      data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                </li>
        ...
        @endcan
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                <span class="menu-title" data-i18n="nav.dash.main">اقتراح خصائص للمنتجات </span>
                <span
                    class="badge badge badge-success badge-pill float-right mr-2"> </span>
            </a>
            <ul class="menu-content">
            <li class="active"><a class="menu-item" href="{{route('admin.products.var.suggest')}}"
                                      data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                </li>
                <li><a class="menu-item" href="{{route('admin.products.var.suggest.create')}}" data-i18n="nav.dash.crypto">أضافة
                        خاصية جديد   </a>
                </li>
        ...
        <ul class="menu-content">
            ...
            <li><a class="menu-item" href="{{route('admin.tags.create')}}" data-i18n="nav.dash.crypto">أضافة علامة
                      </a>
            </li>
        </ul>
        </li>
        ...
        @endcan
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <li><a class="menu-item" href="#"
                    data-i18n="nav.templates.vert.main"> سلايدر </a>
                 <ul class="menu-content">
